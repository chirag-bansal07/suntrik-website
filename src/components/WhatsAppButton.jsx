  ...
  return (
    <>
      <a href={WA_LINK} target="_blank" rel="noopener noreferrer" aria-label="Chat with Suntrik on WhatsApp" className="wa-fab">
        ...
        <svg className="wa-fab-icon" width="30" height="30" viewBox="0 0 32 32" fill="#fff" aria-hidden="true">
      ...
      <style>{`
        .wa-fab {
          ...
          box-shadow: 0 10px 30px rgba(37,211,102,0.38), inset 0 1px 0 rgba(255,255,255,0.35);
          transition: transform 0.25s ease, box-shadow 0.25s ease, background 0.25s ease;
        }
        .wa-fab:hover {
          transform: scale(1.08) translateY(-1px);
          background: linear-gradient(145deg, rgba(37,211,102,0.42), rgba(37,211,102,0.18));
          box-shadow: 0 16px 46px rgba(37,211,102,0.55), inset 0 1px 0 rgba(255,255,255,0.4);
        }
